...
# Signature based derivation - Overview v2
...
![protocol-flow-1.svg](/privacy-pools/protocol-flow-1.svg)
...
# Hardware-Native derivation - Overview v2
...
![protocol-flow-2.svg](/privacy-pools/protocol-flow-2.svg)
...
![signature-base-derivation.svg](/privacy-pools/signature-base-derivation.svg)
...
![in-wallet-derivation.svg](/privacy-pools/in-wallet-derivation.svg)
