...
class SurfaceCodeConfig:
    ...
    code_task: str = "surface_code:rotated_memory_x"  # or "surface_code:rotated_memory_z"
...
if __name__ == "__main__":
    ...
    print("\n[3] Skip full threshold sweep for testing...")
    ...
    serializable_results = {
        f"d{d}_p{p:.2e}": data
        for (d, p), data in quick_results.items()
    }
    serializable_results["threshold_estimate"] = p_th
    ...
    # ── LaTeX table ──
    latex = generate_latex_table(quick_results, p_th)
