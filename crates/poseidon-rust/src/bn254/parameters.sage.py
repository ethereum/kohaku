...
# This file was *autogenerated* from the file src/bn254/parameters.sage
from sage.all_cmdline import *   # import sage library

_sage_const_7 = Integer(7); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0); _sage_const_8 = Integer(8); _sage_const_16 = Integer(16); _sage_const_160 = Integer(160); _sage_const_62 = Integer(62); _sage_const_51 = Integer(51); _sage_const_38 = Integer(38); _sage_const_23 = Integer(23); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_10 = Integer(10); _sage_const_30 = Integer(30)## the following is a copy of https://extgit.iaik.tugraz.at/krypto/hadeshash/-/blob/master/code/generate_parameters_grain.sage which is used to generate the poseidon constants
# Usage:  sage parameters.sage 1 0 254 <t> 8 <r> 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001
# where t an r is:
#  t |  r
# -------
#  2 | 56
...
def perm(input_words, matrix, round_constants):
    ...
    for r in range(_sage_const_0 , R_f):
        ...
        for i in range(_sage_const_0 , NUM_CELLS):
...
state_in  = vector([F(i) for i in range(NUM_CELLS)])
state_out = perm(state_in, linear_layer, round_constants)

def to_hex(value):
    l = len(hex(PRIME_NUMBER-_sage_const_1 ))
...
def print_to_hex(value):
    value = to_hex(value)
    print("            field_from_hex_string(\"{}\").unwrap(),".format(value))
...
for i in range(NUM_CELLS):
    print(i, end="")
    if i != NUM_CELLS - _sage_const_1 :
        print(", ", end="")
print("]) = [", end = "")
for i in range(NUM_CELLS):
    print(to_hex(state_out[i]), end="")
    if i != NUM_CELLS - _sage_const_1 :
        print(", ", end="")
print("];")

print("use crate::{field_from_hex_string, parameters::PoseidonParams};")
print("use lazy_static::lazy_static;")
print("use std::sync::Arc;")
print()
print("type Scalar = ark_bn254::Fr;")
print()
print("lazy_static! {")
print("    static ref MDS: Vec<Vec<Scalar>> = vec![")
for vec in linear_layer:
    print("        vec![")
    for val in vec:
        print_to_hex(val)
    print("        ],")
print("    ];")
print("    static ref RC: Vec<Vec<Scalar>> = vec![")
for (i,val) in enumerate(round_constants):
    if i % NUM_CELLS == _sage_const_0 :
        print("        vec![")
    print_to_hex(val)
    if i % NUM_CELLS == NUM_CELLS - _sage_const_1 :
        print("        ],")
print("    ];")
print("    pub static ref POSEIDON_CIRCOM_BN_{}_PARAMS: Arc<PoseidonParams<Scalar>> =".format(NUM_CELLS))
print("        Arc::new(PoseidonParams::new({}, {}, {}, {}, MDS.to_vec(), RC.to_vec()).unwrap());".format(NUM_CELLS, alpha, R_F_FIXED, R_P_FIXED))
print("}")
