...
export async function sendERC4337Transaction(
    ...
    try {
        ...
        console.log("📋 UserOp BEFORE signing:");
...
console.log("   signature:", userOp.signature.slice(0, 50) + "...");
...
console.log("📋 UserOp AFTER signing:");
console.log("   signature:", userOp.signature.slice(0, 200) + "...");
...
// Check if bundler URL is provided
        if (!bundlerUrl || bundlerUrl.trim() === '' || bundlerUrl.includes('example.com')) {
            ...
            console.log("");
            console.log("To submit this UserOperation, provide the bundler URL in the form.");
