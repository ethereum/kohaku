...
export class RailgunVersionedSmartContracts {
  ...
  static getAccumulator(txidVersion: TXIDVersion, chain: Chain) {
    switch (txidVersion) {
      case TXIDVersion.V2_PoseidonMerkle: {
        return ContractStore.railgunSmartWalletContracts.getOrThrow(
          null,
          chain
        );
      }
      case TXIDVersion.V3_PoseidonMerkle: {
        return ContractStore.poseidonMerkleAccumulatorV3Contracts.getOrThrow(
          null,
          chain
        );
      }
  ...
  static getVerifier(txidVersion: TXIDVersion, chain: Chain) {
    switch (txidVersion) {
      case TXIDVersion.V2_PoseidonMerkle: {
        const contractV2 = ContractStore.railgunSmartWalletContracts.getOrThrow(
          null,
          chain
        );
      ...
      case TXIDVersion.V3_PoseidonMerkle: {
        return ContractStore.poseidonMerkleVerifierV3Contracts.getOrThrow(
          null,
          chain
        );
      }
  ...
  static getHistoricalEvents(
    ...
    switch (txidVersion) {
      ...
      case TXIDVersion.V3_PoseidonMerkle: {
        const contractV3 =
          ContractStore.poseidonMerkleAccumulatorV3Contracts.getOrThrow(
            null,
            chain
          );
  ...
  static fees(
    ...
    switch (txidVersion) {
      ...
      case TXIDVersion.V3_PoseidonMerkle: {
        const contractTokenVaultV3 =
          ContractStore.tokenVaultV3Contracts.getOrThrow(null, chain);
    ...
    switch (txidVersion) {
      ...
      case TXIDVersion.V3_PoseidonMerkle: {
        const contractV3PoseidonMerkleVerifier =
          ContractStore.poseidonMerkleVerifierV3Contracts.getOrThrow(
            null,
            chain
          );
  ...
  static generateTransact(
    ...
    switch (txidVersion) {
      case TXIDVersion.V2_PoseidonMerkle: {
        ...
        return contractV2.generateTransact(
      ...
      case TXIDVersion.V3_PoseidonMerkle: {
        ...
        const globalBoundParams = (transactions[0] as TransactionStructV3)
          .boundParams.global;
        const contractV3PoseidonMerkleVerifier =
          ContractStore.poseidonMerkleVerifierV3Contracts.getOrThrow(
            null,
    ...
    return transactions.map((transaction) => ({
      ...
      boundParams: {
        ...
        commitmentCiphertext:
          transaction.boundParams.local.commitmentCiphertext,
      },
    }));
  }
}
