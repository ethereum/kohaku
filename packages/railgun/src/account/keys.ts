...
export const deriveKeysFromPrivateKeys: (config: KeyConfigPrivateKey) => Promise<DerivedKeys> = async ({ spendingKey, viewingKey, ethKey }) => {
...
export const deriveKeys = async (config: KeyConfig) => match(config)
