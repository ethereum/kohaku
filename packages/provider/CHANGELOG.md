...
- 4c5e47b: Add anon-rpc provider backend: wraps a hash-pinned, sandboxed anon-rpc worker
...
- e3735d4: Upgrade the `@corpus-core/colibri-stateless` peer dependency range to `>=3.0.0 <4`.
